...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.specular"), 0.83f, 0.83f, 0.83f);
        glUniform1f(glGetUniformLocation(lightingShader.Program, "material.shininess"), 30.0f);

        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.diffuse"), 0.0f, 1.0f, 0.0f);
        pokearriba.Draw(lightingShader);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.specular"), 0.66f, 0.66f, 0.66f);
        glUniform1f(glGetUniformLocation(lightingShader.Program, "material.shininess"), 30.0f);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.specular"), 0.33f, 0.33f, 0.33f);
        glUniform1f(glGetUniformLocation(lightingShader.Program, "material.shininess"), 30.0f);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.specular"), 0.16f, 0.16f, 0.16f);
        glUniform1f(glGetUniformLocation(lightingShader.Program, "material.shininess"), 30.0f);
